...
private:
    ...
    struct BenchmarkExecution
    {
        ...
        template< int n >
        void
        operator()( MPIBenchmarkReport< typename Clock::duration > &, int );
    };
};
...
template< typename Clock >
template< typename T >
typename Clock::duration MPIBenchmark< DatasetFillerProvider >::
    BenchmarkExecution< Clock >::writeBenchmark(
        std::string const & compression,
        uint8_t level,
        Offset & offset,
        Extent & extent,
...
template< typename T >
typename Clock::duration MPIBenchmark< DatasetFillerProvider >::
    BenchmarkExecution< Clock >::readBenchmark(
        Offset & offset,
        Extent & extent,
        std::string extension,
        typename decltype( Series::iterations )::key_type iterations )
...
template< typename Clock >
template< typename T >
void MPIBenchmark< DatasetFillerProvider >::BenchmarkExecution< Clock >::
operator()(
...
template< typename Clock >
template< int n >
void MPIBenchmark< DatasetFillerProvider >::BenchmarkExecution<
    Clock >::operator()( MPIBenchmarkReport< typename Clock::duration > &, int )
{
