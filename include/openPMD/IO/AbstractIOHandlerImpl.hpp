...
public:
     ...
     *
     */
    virtual void availableChunks(
        Writable *, Parameter< Operation::AVAILABLE_CHUNKS > & ) = 0;
    ...
    virtual void createDataset(
        Writable *, Parameter< Operation::CREATE_DATASET > const & ) = 0;
     ...
     */
    virtual void extendDataset(
        Writable *, Parameter< Operation::EXTEND_DATASET > const & ) = 0;
    ...
    virtual void deleteDataset(
        Writable *, Parameter< Operation::DELETE_DATASET > const & ) = 0;
    ...
    virtual void deleteAttribute(
        Writable *, Parameter< Operation::DELETE_ATT > const & ) = 0;
     ...
     */
    virtual void writeDataset(
        Writable *, Parameter< Operation::WRITE_DATASET > const & ) = 0;
     ...
     */
    virtual void getBufferView(
        Writable *, Parameter< Operation::GET_BUFFER_VIEW > & parameters )
    {
     ...
     */
    virtual void
    listPaths( Writable *, Parameter< Operation::LIST_PATHS > & ) = 0;
