...
inline U getCast( Attribute const & a )
{
    ...
    if( auto pvalue_c = variantSrc::get_if< char >( &v ) )
        ...
        auto pvalue_cld =
            variantSrc::get_if< std::complex< long double > >( &v ) )
    ...
    // vector
        ...
        auto pvalue_vuc =
            variantSrc::get_if< std::vector< unsigned char > >( &v ) )
        ...
        auto pvalue_vld =
            variantSrc::get_if< std::vector< long double > >( &v ) )
        return DoConvert< std::vector< long double >, U >{}( pvalue_vld );
    else if(
        auto pvalue_vcf =
            variantSrc::get_if< std::vector< std::complex< float > > >( &v ) )
        return DoConvert< std::vector< std::complex< float > >, U >{}(
            pvalue_vcf );
    else if(
        auto pvalue_vcd =
            variantSrc::get_if< std::vector< std::complex< double > > >( &v ) )
        return DoConvert< std::vector< std::complex< double > >, U >{}(
            pvalue_vcd );
    else if(
        auto pvalue_vcld =
            variantSrc::get_if< std::vector< std::complex< long double > > >(
                &v ) )
        return DoConvert< std::vector< std::complex< long double > >, U >{}(
            pvalue_vcld );
    else if(
        auto pvalue_vstr =
            variantSrc::get_if< std::vector< std::string > >( &v ) )
