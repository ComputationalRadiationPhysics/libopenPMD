...
void write_and_read_many_iterations( std::string const & ext )
{
...
inline void empty_dataset_test( std::string file_ending )
{
    ...
    }
    {
        ...
        REQUIRE( series.iterations[ 1 ].meshes[ "rho" ].contains(
            "makeEmpty_dim_7_int" ) );
...
inline void constant_scalar( std::string file_ending )
{
...

    {
        // constant scalar
        Series s = Series(
            "../samples/constant_scalar." + file_ending, Access::CREATE );
        auto rho =
            s.iterations[ 1 ].meshes[ "rho" ][ MeshRecordComponent::SCALAR ];
        ...
        auto posOff = s.iterations[ 1 ].particles[ "e" ][ "positionOffset" ]
...

    {
        ...
        REQUIRE(
            s.iterations[ 1 ].meshes[ "rho" ].count(
                MeshRecordComponent::SCALAR ) == 1 );
        ...
        REQUIRE( s.iterations[ 1 ].meshes[ "E" ][ "x" ].containsAttribute(
            "shape" ) );
        REQUIRE(
            s.iterations[ 1 ]
                .meshes[ "E" ][ "x" ]
        ...
        REQUIRE(
            s.iterations[ 1 ].meshes[ "E" ][ "y" ].getExtent() ==
            Extent{ 1, 2, 3 } );
        REQUIRE( s.iterations[ 1 ].meshes[ "E" ].count( "y" ) == 1 );
        REQUIRE( !s.iterations[ 1 ].meshes[ "E" ][ "y" ].containsAttribute(
            "shape" ) );
        REQUIRE( !s.iterations[ 1 ].meshes[ "E" ][ "y" ].containsAttribute(
            "value" ) );
        REQUIRE(
        ...
        REQUIRE(
            s.iterations[ 1 ].particles[ "e" ].count( "positionOffset" ) == 1 );
        REQUIRE(
        ...
        REQUIRE(
            s.iterations[ 1 ].particles[ "e" ][ "velocity" ].count( "x" ) ==
            1 );
        REQUIRE( s.iterations[ 1 ]
        ...
        REQUIRE(
            s.iterations[ 1 ]
                ...
                .getExtent() == Extent{ 3, 2, 1 } );
        REQUIRE(
            s.iterations[ 1 ].particles[ "e" ][ "velocity" ].count( "y" ) ==
            1 );
        REQUIRE( !s.iterations[ 1 ]
                      .particles[ "e" ][ "velocity" ][ "y" ]
                      .containsAttribute( "shape" ) );
        REQUIRE( !s.iterations[ 1 ]
                      .particles[ "e" ][ "velocity" ][ "y" ]
                      .containsAttribute( "value" ) );
        ...
        auto E_x_value =
            s.iterations[ 1 ].meshes[ "E" ][ "x" ].loadChunk< float >();
        s.flush();
...
inline void particle_patches( std::string file_ending )
{
    ...
    uint64_t const num_patches = 2u;
    {
        ...
        for( auto r : { "x", "y" } )
        {
            auto x = e[ "position" ][ r ];
            x.resetDataset(
                Dataset( determineDatatype< float >(), { extent } ) );
            std::vector< float > xd( extent );
            std::iota( xd.begin(), xd.end(), 0 );
            x.storeChunk( xd );
            auto o = e[ "positionOffset" ][ r ];
            o.resetDataset(
                Dataset( determineDatatype< uint64_t >(), { extent } ) );
        ...
        e.particlePatches[ "numParticlesOffset" ][ SCALAR ].resetDataset(
            dset_n );
        ...
        e.particlePatches[ "numParticles" ][ SCALAR ].store(
            0, uint64_t( 10u ) );
        e.particlePatches[ "numParticlesOffset" ][ SCALAR ].store(
            0, uint64_t( 0u ) );
    ...
    }
    {
        ...
        auto numParticles = e.particlePatches[ "numParticles" ][ SCALAR ]
                                .template load< uint64_t >();
        auto numParticlesOffset =
            e.particlePatches[ "numParticlesOffset" ][ SCALAR ]
                .template load< uint64_t >();
        auto extent_x =
            e.particlePatches[ "extent" ][ "x" ].template load< float >();
        auto extent_y =
            e.particlePatches[ "extent" ][ "y" ].template load< float >();
        auto offset_x =
            e.particlePatches[ "offset" ][ "x" ].template load< float >();
        auto offset_y =
            e.particlePatches[ "offset" ][ "y" ].template load< float >();
...
inline void dtype_test( const std::string & backend )
{
    ...
    bool test_long_long = ( backend != "json" ) || sizeof( long long ) <= 8;
    {
        ...
        s.setAttribute(
            "vecChar", std::vector< char >( { 'c', 'h', 'a', 'r' } ) );
        s.setAttribute(
            "vecInt16", std::vector< int16_t >( { 32766, 32767 } ) );
        s.setAttribute(
        ...
        s.setAttribute(
            "vecUint16", std::vector< uint16_t >( { 65534u, 65535u } ) );
        s.setAttribute(
            "vecUint32",
        ...
        s.setAttribute(
            "vecFloat", std::vector< float >( { 0.f, 3.40282e+38f } ) );
        s.setAttribute(
            "vecDouble", std::vector< double >( { 0., 1.79769e+308 } ) );
        if( test_long_double )
        {
            s.setAttribute(
                "vecLongdouble",
        ...
        s.setAttribute(
            "vecLong", std::vector< long >( { 2147483646, 2147483647 } ) );
        if( test_long_long )
        {
            s.setAttribute(
                "vecLongLong",
        ...
        s.setAttribute(
            "vecUInt", std::vector< unsigned int >( { 65533u, 65531u } ) );
        s.setAttribute(
    ...
    {
        REQUIRE(
            s.getAttribute( "longdouble" ).get< long double >() == 1.e80L );
    }
    ...
    {
        REQUIRE(
            s.getAttribute( "vecLongdouble" )
                .get< std::vector< long double > >() ==
            std::vector< long double >(
                { 0.L, std::numeric_limits< long double >::max() } ) );
    }
    REQUIRE(
    ...
    {
        REQUIRE(
            isSame( s.getAttribute( "longlong" ).dtype, Datatype::LONGLONG ) );
    }
    ...
    {
        REQUIRE( isSame(
            s.getAttribute( "ulonglong" ).dtype, Datatype::ULONGLONG ) );
    }

    REQUIRE(
        isSame( s.getAttribute( "vecShort" ).dtype, Datatype::VEC_SHORT ) );
    ...
    REQUIRE(
        isSame( s.getAttribute( "vecUShort" ).dtype, Datatype::VEC_USHORT ) );
    REQUIRE( isSame( s.getAttribute( "vecUInt" ).dtype, Datatype::VEC_UINT ) );
    REQUIRE(
        isSame( s.getAttribute( "vecULong" ).dtype, Datatype::VEC_ULONG ) );
    if( test_long_long )
    {
        REQUIRE( isSame(
            s.getAttribute( "vecULongLong" ).dtype, Datatype::VEC_ULONGLONG ) );
...
{
    {
        ...
        o.setAttribute(
            "butComplexFloats", std::complex< float >( 42.3, -99.3 ) );
        if( backend != "bp" )
            o.setAttribute(
                "longDoublesYouSay",
        ...
        auto Cflt =
            o.iterations[ 0 ].meshes[ "Cflt" ][ RecordComponent::SCALAR ];
        ...
        auto Cdbl =
            o.iterations[ 0 ].meshes[ "Cdbl" ][ RecordComponent::SCALAR ];
...

    {
        ...
        REQUIRE(
            i.getAttribute( "butComplexFloats" )
                .get< std::complex< float > >() ==
        ...
        if( backend != "bp" )
        {
            ...
            i.flush();
            REQUIRE(
                rcldbl.get()[ 2 ] == std::complex< long double >( 7., -6. ) );
        }
    }
...
inline void fileBased_write_test( const std::string & backend )
{
    ...
    {
        Series o = Series(
            "../samples/subdir/serial_fileBased_write%08T." + backend,
            Access::CREATE );
        ...
        {
            *position_local_1 = position_global[ i ];
            e_1[ "position" ][ "x" ].storeChunk(
                position_local_1, { i }, { 1 } );
            *positionOffset_local_1 = positionOffset_global[ i ];
            e_1[ "positionOffset" ][ "x" ].storeChunk(
                positionOffset_local_1, { i }, { 1 } );
            o.flush();
        ...
        {
            *position_local_3 = position_global[ i ];
            e_3[ "position" ][ "x" ].storeChunk(
                position_local_3, { i }, { 1 } );
            *positionOffset_local_3 = positionOffset_global[ i ];
            e_3[ "positionOffset" ][ "x" ].storeChunk(
                positionOffset_local_3, { i }, { 1 } );
            o.flush();
    ...
    REQUIRE( (
        auxiliary::file_exists(
            "../samples/subdir/serial_fileBased_write00000001." + backend ) ||
        auxiliary::directory_exists(
            "../samples/subdir/serial_fileBased_write00000001." + backend ) ) );
    REQUIRE( (
        auxiliary::file_exists(
            "../samples/subdir/serial_fileBased_write00000002." + backend ) ||
        auxiliary::directory_exists(
            "../samples/subdir/serial_fileBased_write00000002." + backend ) ) );
    REQUIRE( (
        auxiliary::file_exists(
            "../samples/subdir/serial_fileBased_write00000003." + backend ) ||
        auxiliary::directory_exists(
            "../samples/subdir/serial_fileBased_write00000003." + backend ) ) );

    {
        ...
        for( auto & entry : o.iterations )
        {
            ...
            REQUIRE(
                it.time< double >() == static_cast< double >( entry.first ) );
...
#if !defined( _MSC_VER )
            REQUIRE(
                posOff_x.getDatatype() == determineDatatype< uint64_t >() );
#endif
            REQUIRE( isSame(
                posOff_x.getDatatype(), determineDatatype< uint64_t >() ) );
            ...
            auto positionOffset =
                posOff_x.loadChunk< uint64_t >( { 0 }, { 4 } );
            ...
            for( uint64_t j = 0; j < 4; ++j )
            {
                ...
                REQUIRE(
                    positionOffset_raw[ j ] == j + ( entry.first - 1 ) * 4 );
            }
        }
    ...
    REQUIRE( (
        auxiliary::file_exists(
            "../samples/subdir/serial_fileBased_write00000004." + backend ) ||
        auxiliary::directory_exists(
            "../samples/subdir/serial_fileBased_write00000004." + backend ) ) );
...
inline void sample_write_thetaMode( std::string file_ending )
{
    ...
    for( int i = 0; i <= 400; i += 100 )
    {
        ...
        E_z.resetDataset( Dataset(
            ...
            { num_fields,
              N_r,
              N_z } ) ); // (modes, r, z) see setGeometryParameters
        ...
        E_r.storeChunk(
            E_r_data, Offset{ 0, 0, 0 }, Extent{ num_fields, N_r, N_z } );
        ...
        E_t.storeChunk(
            E_t_data, Offset{ 0, 0, 0 }, Extent{ num_fields, N_r, N_z } );
...
inline void bool_test( const std::string & backend )
{
    {
        Series o =
            Series( "../samples/serial_bool." + backend, Access::CREATE );
    ...
    }
    {
        ...
        REQUIRE(
            std::count(
                attrs.begin(), attrs.end(), "Bool attribute (false)" ) == 1 );
        REQUIRE(
            o.getAttribute( "Bool attribute (true)" ).get< bool >() == true );
        REQUIRE(
            o.getAttribute( "Bool attribute (false)" ).get< bool >() == false );
    }
    {
...
inline void optional_paths_110_test( const std::string & backend )
{
    ...
    {
        {
            ...
            REQUIRE(
                std::count( attrs.begin(), attrs.end(), "meshesPath" ) == 1 );
            REQUIRE(
                std::count( attrs.begin(), attrs.end(), "particlesPath" ) ==
                1 );
...

    {
        ...
        REQUIRE(
            std::count( attrs.begin(), attrs.end(), "particlesPath" ) == 0 );
    ...
    {
        {
            ...
            REQUIRE( s.iterations[ 50 ].particles[ "electrons" ].contains(
                "momentum" ) );
            REQUIRE( s.iterations[ 50 ]
                         .particles[ "electrons" ][ "momentum" ]
                         .contains( "x" ) );
            auto empty_rc = s.iterations[ 50 ]
            ...
            REQUIRE( isSame(
                empty_rc.getDatatype(), determineDatatype< double >() ) );
        }
        {
            Series list{
                "../samples/issue-sample/empty_alternate_fbpic_%T.h5",
    ...
    try
    {
        ...
        REQUIRE(
            o.iterations[ 100 ]
                ...
                .parent() ==
            getWritable(
                &o.iterations[ 100 ].particles[ "electrons" ][ "momentum" ] ) );
        REQUIRE(
            o.iterations[ 100 ]
        ...
        REQUIRE(
            o.iterations[ 100 ]
                ...
                .parent() ==
            getWritable(
                &o.iterations[ 100 ].particles[ "electrons" ][ "position" ] ) );
        REQUIRE(
            o.iterations[ 100 ]
...
TEST_CASE( "git_hdf5_sample_attribute_test", "[serial][hdf5]" )
{
    try
    {
        ...
        RecordComponent & weighting_scalar =
            weighting[ RecordComponent::SCALAR ];
    ...
    try
    {
...

        {
            ...
            RecordComponent & electrons_mass =
                o.iterations[ 100 ].particles[ "electrons" ][ "mass" ]
                                             [ RecordComponent::SCALAR ];
            Offset offset{ 15 };
            Extent extent{ 3 };
...
TEST_CASE( "hzdr_hdf5_sample_content_test", "[serial][hdf5]" )
{
    ...
    try
    {
        ...
        REQUIRE(
            e_chargeDensity.timeOffset< float >() ==
            static_cast< float >( 0.0f ) );
        ...
        REQUIRE(
            e_energyDensity.timeOffset< float >() ==
            static_cast< float >( 0.0f ) );
        ...
        REQUIRE(
            e_charge.timeOffset< float >() == static_cast< float >( 0.0f ) );
        ...
        REQUIRE(
            e_momentum.timeOffset< float >() == static_cast< float >( 0.0f ) );
        ...
        REQUIRE(
            e_position.timeOffset< float >() == static_cast< float >( 0.0f ) );
        ...
        REQUIRE(
            e_positionOffset.timeOffset< float >() ==
            static_cast< float >( 0.0f ) );
        ...
        REQUIRE(
            e_positionOffset_x.getDatatype() ==
            determineDatatype< int32_t >() );
        ...
        REQUIRE(
            e_positionOffset_y.getDatatype() ==
            determineDatatype< int32_t >() );
        ...
        REQUIRE(
            e_positionOffset_z.getDatatype() ==
            determineDatatype< int32_t >() );
        ...
        REQUIRE(
            e_weighting.timeOffset< float >() == static_cast< float >( 0.0f ) );
...
#endif
        REQUIRE( isSame(
            e_extent_x.getDatatype(), determineDatatype< uint64_t >() ) );
...
#endif
        REQUIRE( isSame(
            e_extent_y.getDatatype(), determineDatatype< uint64_t >() ) );
...
#endif
        REQUIRE( isSame(
            e_extent_z.getDatatype(), determineDatatype< uint64_t >() ) );
...
#endif
        REQUIRE( isSame(
            e_offset_x.getDatatype(), determineDatatype< uint64_t >() ) );
...
#endif
        REQUIRE( isSame(
            e_offset_y.getDatatype(), determineDatatype< uint64_t >() ) );
...
#endif
        REQUIRE( isSame(
            e_offset_z.getDatatype(), determineDatatype< uint64_t >() ) );
    }
    catch( no_such_file_error & e )
    {
