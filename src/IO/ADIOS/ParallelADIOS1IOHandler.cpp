...
ParallelADIOS1IOHandlerImpl::ParallelADIOS1IOHandlerImpl(
    ...
    : AbstractIOHandlerImpl{ handler }, m_mpiInfo{ MPI_INFO_NULL }
{
...
ParallelADIOS1IOHandler::ParallelADIOS1IOHandler(
    std::string path, Access at, MPI_Comm comm )
...
#else
ParallelADIOS1IOHandler::ParallelADIOS1IOHandler( std::string path, Access at )
