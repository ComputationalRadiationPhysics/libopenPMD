    ...
    if( buf.ndim == 0 )
    {
        ...
        case DT::LONGLONG:
            return attr.setAttribute(
                key, *static_cast< long long * >( buf.ptr ) );
            break;
        case DT::USHORT:
            return attr.setAttribute(
        ...
        case DT::DOUBLE:
            return attr.setAttribute(
                key, *static_cast< double * >( buf.ptr ) );
            break;
        case DT::LONG_DOUBLE:
            return attr.setAttribute(
                key, *static_cast< long double * >( buf.ptr ) );
            break;
        case DT::CFLOAT:
            return attr.setAttribute(
...
struct SetAttributeFromObject
{
    ...
    bool
    operator()( Attributable & attr, std::string const & key, py::object & obj )
    {
...
void init_Attributable( py::module & m )
{
    py::class_< Attributable >( m, "Attributable" )
        ...
        .def(
            "series_flush", py::overload_cast<>( &Attributable::seriesFlush ) )
        ...
        .def(
            "set_attribute",
            &Attributable::setAttribute< std::vector< long > > )
        .def(
            "set_attribute",
        ...
        .def_property_readonly(
            ...
            []( Attributable const & attributable ) {
                ...
                {
                    dtypes[ attr ] = dtype_to_numpy(
                        attributable.getAttribute( attr ).dtype );
                }
                return dtypes;
            } )
