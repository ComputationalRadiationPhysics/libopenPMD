    ...
    Extent const & extent )
{
    ...
    if( r.getDatatype() == Datatype::CHAR )
        r.loadChunk< char >(
            shareRaw( ( char * )buffer_info.ptr ), offset, extent );
        ...
        r.loadChunk< short >(
            shareRaw( ( short * )buffer_info.ptr ), offset, extent );
    else if( r.getDatatype() == Datatype::INT )
        r.loadChunk< int >(
            shareRaw( ( int * )buffer_info.ptr ), offset, extent );
    else if( r.getDatatype() == Datatype::LONG )
        r.loadChunk< long >(
            shareRaw( ( long * )buffer_info.ptr ), offset, extent );
        ...
        r.loadChunk< unsigned long long >(
            shareRaw( ( unsigned long long * )buffer_info.ptr ),
            offset,
            extent );
        ...
        r.loadChunk< float >(
            shareRaw( ( float * )buffer_info.ptr ), offset, extent );
        ...
        r.loadChunk< std::complex< double > >(
            shareRaw( ( std::complex< double > * )buffer_info.ptr ),
            offset,
            extent );
    else if( r.getDatatype() == Datatype::CFLOAT )
        r.loadChunk< std::complex< float > >(
            shareRaw( ( std::complex< float > * )buffer_info.ptr ),
            offset,
            extent );
    else if( r.getDatatype() == Datatype::BOOL )
        r.loadChunk< bool >(
            shareRaw( ( bool * )buffer_info.ptr ), offset, extent );
    else
        throw std::runtime_error(
...
void init_RecordComponent( py::module & m )
{
    ...
    py::class_< RecordComponent, BaseRecordComponent > cl(
        m, "Record_Component" );
    cl.def(
          "__repr__",
