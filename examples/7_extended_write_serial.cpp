...
int main()
{
...

    {
        ...
        // copies
        {
            ...
            // code
            f.iterations[ 1 ].setTime( 42.0 ).setDt( 1.0 ).setTimeUnitSI(
                1.39e-16 );
        ...
        d.setCustomTransform(
            "blosc:compressor=zlib,shuffle=bit,lvl=1;nometa" );
        ...
        for( uint64_t i = 0u; i < 2u; ++i )
        {
            ...
            {
                partial_particlePos.get()[ idx ] =
                    particle_position[ idx + 2 * i ];
            ...
            electrons[ "position" ][ "x" ].storeChunk(
                partial_particlePos, o, e );
